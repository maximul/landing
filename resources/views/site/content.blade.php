...
@if(isset($peoples) && is_object($peoples))
    ...
    <section class="page_section team" id="team">
        <div class="container">
            <h2>Team</h2>
            <h6>Lorem ipsun dolor sit amet, consectetur adipiscing.</h6>
            ...
            <div class="row">
                <div class="col-lg-4 wow fadeInLeft">
                    ...
                    <ul class="social_links">
                        <li class="twitter animated bounceIn wow delay-02s"><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
                        <li class="facebook animated bounceIn wow delay-03s"><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
                        <li class="pinterest animated bounceIn wow delay-04s"><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
                        <li class="gplus animated bounceIn wow delay-05s"><a href="javascript:void(0)" class="fa fa-google-plus"></a></li>
                    </ul>
                </div>
